const scapper = require("./shaanapi.js");
...
app.get("/getSubCategory/:subCategory/:page", async (req, res) => {
  const result = await scapper.subCategories(
...
app.get("/searchPage/:query/:page", async (req, res) => {
  const result = await scapper.searchPagination(
    req.params.query,
    req.params.page
  );
  res.header("Content-Type", "application/json");
...
app.get("/subCategoryPage/:subCategory/:page", async (req, res) => {
  const result = await scapper.subCategoryPagination(
    req.params.subCategory,
    req.params.page
  );
  res.header("Content-Type", "application/json");
